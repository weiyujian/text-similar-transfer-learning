...
tf.flags.DEFINE_string("domain_train_file", "./data/cnews.train.txt.seg", "train data for Chinese.")#'/home/jwy/insuranceQA-cnn-lstm-master/insuranceQA/train'
tf.flags.DEFINE_string("domain_dev_file", "./data/cnews.test.seg", "val data for Chinese.")
...
raw, label_map = insurance_qa_data_helpers.read_raw(FLAGS.domain_train_file)#get true query vs answer
...
alist,avec_list = insurance_qa_data_helpers.read_alist(FLAGS.domain_train_file, vocab, max_seq_len, FLAGS.embedding_type)#raw_label_list,id_label_list

testList = insurance_qa_data_helpers.load_test(FLAGS.domain_dev_file, alist)
