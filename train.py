...
tf.flags.DEFINE_string("train_file", "./data/cnews.train.seg", "train data for Chinese.")
tf.flags.DEFINE_string("domain_train_file", "./data/cnews.train.txt.seg", "domain train data for Chinese.")
...
with tf.Graph().as_default():
  with tf.device("/gpu:1"):
    ...
    with sess.as_default():
        ...
        if FLAGS.is_test:
            domain_out_dir = os.path.abspath(os.path.join(os.path.curdir, "runs", FLAGS.model_version))
        else:
